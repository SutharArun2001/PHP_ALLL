...
<body>
    ...
    <div id="main">
        ...
        <div class="formcontainer">
            ...
            <h2>UPDATE ADD MANAGER INFO</h2>
            <?php
            if (isset($_GET['editmng'])) {
                $userid = $_GET['editmng'];
            ...
            <form method="GET" enctype="multipart/form-data" id="formm" name="myform">
                <input name="userid" id="userid" value="<?php echo $mngid ?>" hidden>
                <div class="col">
                    <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <br><input type="text" class="typeinput" value="<?php echo $phonenumber; ?>" id="phonenumber"
    ...
    <script>
        ...
        $('form').bind('submit', function (e) {
            ...
            var queryString = 'jobrole=' + 'manager' + '&mngid=' + userid + '&firstname=' + firstname + '&lastname=' + lastname + '&email=' + email + '&phonenumber=' + phonenumber + '&gender=' + gender + '&department=' + department;
