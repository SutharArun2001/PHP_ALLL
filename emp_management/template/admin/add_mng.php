...
<body>
            ...
            <form method="GET" enctype="multipart/form-data" id="formm" name="myform">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <br><input type="text" class="typeinput" id="phonenumber"
                            placeholder="Enter Your Phone Number" name="phonenumber" maxlength="10"><br>
    ...
    <script>
        ...
        $('form').bind('submit', function (e) {
            ...
            var queryString ='jobrole=' + 'manager' + '&firstname=' + firstname + '&lastname=' + lastname + '&email=' + email + '&phonenumber=' + phonenumber + '&gender=' + gender + '&department=' + department;
            if (flag) {
                $.ajax({
                    type: 'post',
