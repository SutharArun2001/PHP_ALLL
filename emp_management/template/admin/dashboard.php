...
<head>
    ...
    <style>
        ...
        * {
        ...
        .topcards .container .items a:hover {
            scale: 1.02;
        }
...
<body>
    ...
    <div id="main">
        <div class="topcards">
            ...
            <div class="container">
                <div class="items one">
                    <a href="dashboard.php?emp='showemp'">
                        <div class="icon">
                ...
                <div class="items two ">
                    <a href="dashboard.php?mng='showwmng'">
                ...
                <div class="items three">
                    <a href="dashboard.php?dpt='showdpt'">
                    ...
                    <tr>
                        ...
                        if (isset($_GET['mngiddtoemp']) || isset($_GET['emp']) == 'showemp') {
                            if ($result->num_rows > 0) {
                                ...
                                <td>' . $manager_name . '</td>
                                <td>
                                    <a href="../../template/admin/editemp.php?&editemp=' . $userid . '">
                                        <div class="actions"><img src="../../asset/icons/edit.svg" alt="" srcset=""></div>
                                    </a>
                                </td>
                                <td>
                                    <a href="../../config/deleterow.php?empidd=' . $userid . '">
                        ...
                        if (isset($_GET['mng']) == 'showmng') {
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <td>' . $department . '</td>
                                    <td>
                                        <a href="../../template/admin/editmng.php?&editmng=' . $userid . '">
                                            <div class="actions"><img src="../../asset/icons/edit.svg" alt="" srcset=""></div>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="../../config/deleterow.php?mngidd=' . $userid . '">
                                            <div class="actions"><img src="../../asset/icons/delete.svg" alt="" srcset=""></div>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="../../template/admin/dashboard.php?&mngiddtoemp=' . $userid . '">
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <td>' . $deptname . '</td>
                                    <td>
                                        <a href="../../template/admin/editdpt.php?&editdpt=' . $deptid . '">
                                            <div class="actions"><img src="../../asset/icons/edit.svg" alt="" srcset=""></div>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="../../config/deleterow.php?dptidd=' . $deptid . '">
                                            <div class="actions"><img src="../../asset/icons/delete.svg" alt="" srcset=""></div>
                                        </a>
                                    </td>';
                                    $srno++;
