...
<body>
                ...
                <div class="col">
                    ...
                    <div class="row">
                        ...
                        <br><input type="text" class="typeinput" id="phonenumber" placeholder="Enter Your Phone Number"
                            name="phonenumber" maxlength="10"><br>
    ...
    <script>
        ...
        $('form').bind('submit', function (e) {
            ...
            console.log(manager);
            var managername = manager[0] + ' ' + manager[1];
            var managerid = manager[2];
            var flag = true;
            ...
            var queryString = 'jobrole=' + 'employee' + '&firstname=' + firstname + '&lastname=' + lastname + '&email=' + email + '&phonenumber=' + phonenumber + '&gender=' + gender + '&department=' + department + '&managername=' + managername + '&managerid=' + managerid;
