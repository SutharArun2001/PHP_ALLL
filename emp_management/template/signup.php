...
<body>
        ...
        <form method="GET" enctype="multipart/form-data" id="formm" name="myform">
            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <br><input type="number" class="typeinput" id="phonenumber" placeholder="Enter Your Phone Number"
                        name="phonenumber" ><br>
            ...
            <div class="col">
                <div class="row">
                    ...
                    <div class="radiogrp">
                        <div>
                            <input type="radio" id="male" value="male" name="gender"><span>Male</span>
                        </div>
                        <div>
                            <input type="radio" id="female" value="female" name="gender"><span>Female</span>
                        </div>
                        <div>
                            <input type="radio" id="other" value="other" name="gender"><span>Other</span>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <select id="jobrole" class="dropdowns" onchange="hidemanager(this.value)" name="jobrole" required>
                        <option value="0" selected>Select your Job Role</option>
            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <select name="manager" style="text-color:var(--placeholder_color)" class="dropdowns" disabled id="manager" onchange="selectmng(this.value)">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<option value="' . $manager_name . ',' . $mngid . '">' . $manager_name . ' [' . $row['department'] . ']' . '</option>';
                            }
                        }
                        ?>
                    </select>
    ...
    <script>
        ...
        $('form').bind('submit', function (e) {
            ...
            if (jobrole == 'employee') {
                var queryString = 'firstname=' + firstname + '&lastname=' + lastname + '&email=' + email + '&phonenumber=' + phonenumber + '&gender=' + gender + '&jobrole=' + jobrole + '&department=' + department + '&managername=' + managername + '&managerid=' + managerid;
                console.log(queryString);
            } else { }
            if (jobrole == 'manager') {
                var queryString = 'firstname=' + firstname + '&lastname=' + lastname + '&email=' + email + '&phonenumber=' + phonenumber + '&gender=' + gender + '&jobrole=' + jobrole + '&department=' + department;
                console.log(queryString);
            } else { }
            if (flag) {
                $.ajax({
