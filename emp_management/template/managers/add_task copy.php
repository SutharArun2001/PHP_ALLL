        ...
        <form method="GET" enctype="multipart/form-data" id="formm" name="myform">
            <div class="col">
                ...
                <div class="row">
                    ...
                    <br><input type="date" class="typeinput" id="duedate" name="duedate" placeholder="Enter Your Last Name">
            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <select class="dropdowns" id="empname" name="empname">
                        ...
                        <?php
                        $showDepart = "select empid , firstname , lastname , department from emp_table";
                        $result = $conn->query($showDepart);
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo '<option value="' . $firstname . ',' . $lastname . ',' . $empid . '">' . $firstname . ' ' . $lastname . ' [' . $department . ']' . '</option>';
                            }
                        }
                        ?>
                    </select>
