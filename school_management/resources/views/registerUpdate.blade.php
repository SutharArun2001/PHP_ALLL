        ...
        <form action="{{ $url }}" id="formm" method="post" enctype="multipart/form-data">
            ...
            <div class="col">
                ...
                <div class="row">
                    ...
                    <img id="user_new_photo" src="/user_photo/{{ $stdinfo->user_photo }}" alt=""
                        srcset="">
                    <input type="text" value="{{ $stdinfo->user_photo }}" hidden name="oldphoto">

                    <br><input type="file" class="typeinput" onchange="changePhoto(event)" id="userphoto"
                        name="userphoto" placeholder="Enter Your userphoto" value="{{ $stdinfo->user_photo }}">
