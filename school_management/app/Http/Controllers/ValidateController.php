...
class ValidateController extends Controller
{
    ...
    public function view(Request $request)
    {
        ...
        // if(Auth::check()){
        //     $status = "Authenication";
        // }else{
        //     $status = "Not Authenication";
        // }
        ...
        $student = Student::all();
        // $stddataa = $student->find(1);
        // $stddataa = $student->except([2]); return value except these primary key
        // $stddataa = $student->fresh('student');
        $stddataa = $student->contains(9);
        $data = compact('student','stddataa');
