<!DOCTYPE html>
<?php include('../emp_management/connection.php'); ?>
<html lang="en">
...
<body>
    <div class="topcards">
        ...
        <div class="container">
            ...
            <div class="items two ">
                <a href="home.php?dashboard='dashboard'?&mng='showwmng'">
            ...
            <div class="items three">
                <a href="home.php?dashboard='dashboard'?&dpt='showdpt'">
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <td>
                                    <a href="home.php?editrow.php?&editemp=' . $userid . '">
                                        <div class="actions"><img src="./icons/edit.svg" alt="" srcset=""></div>
                                    </a>
                                </td>
                                <td>
                                    <a href="deleterow.php?empidd=' . $userid . '">
                                        <div class="actions"><img src="./icons/delete.svg" alt="" srcset=""></div>
                                    </a>
                                </td>
                                </tr>';
                                $srno++;
                                ...
                                echo '<tr>
                                    ...
                                    <td>
                                        <a href="home.php?dashboard=dashboard?&mngiddtoemp=' . $userid . '">
                                            <div class="actions"><img src="./icons/show.svg" alt="" srcset=""></div>
                                        </a>
                                    </td>';
                                $srno++;
                            }
