        ...
        <tbody>
            @foreach ($fruits as $item)
                <tr>
                    ...
                    <td>
                        <div class="btnDiv">
                            {{-- <a href="{{ route('addFavourite', ['id' => $item->fruit_id]) }}"> --}}
                                <div data-fruitId="{{ $item->fruit_id }}" class="actions {{ $item->favourite_flag == 1 ? 'added' : '' }}"><svg
                                    width="50" height="48" viewBox="0 0 50 48" fill="none"
